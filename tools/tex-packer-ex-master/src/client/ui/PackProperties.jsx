...
class PackProperties extends React.Component {
    ...
    updatePackOptions() {
        ...
        if (this.packOptions.animationJsonContent) {
            data.animationJsonContent = this.packOptions.animationJsonContent;
            data.animationJsonName = this.packOptions.animationJsonName;
        }
                ...
                <div className="pack-properties-containter">
                    <table>
                        <tbody>
                            ...
                            {this.packOptions.exporter === "Spritemap (Adobe Animate)" && (
                                <tr title="Opcional: Sube el Animation.json original para actualizar su referencia de textura y empaquetarlo de vuelta en el ZIP.">
                                    ...
                                    <td>
                                        <input type="file" accept=".json" onChange={(e) => {
                                            ...
                                            if (file) {
                                                ...
                                                reader.onload = (event) => {
                                                    this.packOptions.animationJsonContent = event.target.result;
                                                    this.packOptions.animationJsonName = file.name;
                                                    this.onExporterPropChanged();
                                                };
